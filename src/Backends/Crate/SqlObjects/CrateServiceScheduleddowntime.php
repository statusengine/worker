...
class CrateServiceScheduleddowntime extends Crate\CrateModel {
    ...
    VALUES%s
    ON CONFLICT (hostname, service_description, node_name, scheduled_start_time, internal_downtime_id) DO UPDATE SET entry_time=VALUES(entry_time), author_name=VALUES(author_name), comment_data=VALUES(comment_data),
