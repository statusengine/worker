...
class MysqlHoststatus extends MysqlModel {
    ...
    public function insert($isRecursion = false){
        ...
        foreach ($this->BulkInsertObjectStore->getObjects() as $key => $Hoststatus) {
            ...
            $query->bindValue($i++, $this->datetime($Hoststatus->getStatusUpdateTime()));
            ...
            $query->bindValue($i++, $this->datetime($Hoststatus->getLastCheck()));
            $query->bindValue($i++, $this->datetime($Hoststatus->getNextCheck()));
            $query->bindValue($i++, (int)$Hoststatus->getIsActiveCheckResult());
            $query->bindValue($i++, $this->datetime($Hoststatus->getLastStateChange()));
            $query->bindValue($i++, $this->datetime($Hoststatus->getLastHardStateChange()));
            $query->bindValue($i++, $Hoststatus->getLastHardState());
            $query->bindValue($i++, (int)$Hoststatus->isHardState());
            $query->bindValue($i++, $this->datetime($Hoststatus->getLastNotification()));
            $query->bindValue($i++, $this->datetime($Hoststatus->getNextNotification()));
